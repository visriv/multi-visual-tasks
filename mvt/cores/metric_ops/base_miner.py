...
from .module_with_records_and_reducer import ModuleWithRecordsAndDistance
...
class BaseMiner(ModuleWithRecordsAndDistance):
    ...
    def set_ref_emb(self, embeddings, labels, ref_emb, ref_labels):
        if ref_emb is not None:
            ref_labels = c_u.to_device(ref_labels, ref_emb)
        else:
            ref_emb, ref_labels = embeddings, labels
        c_u.assert_embeddings_and_labels_are_same_size(ref_emb, ref_labels)
