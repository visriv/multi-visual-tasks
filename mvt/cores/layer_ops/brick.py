...
class ResConv2dBatchLeaky(nn.Module):
    def __init__(
        ...
        self.layers2 = Conv2dBatchLeaky(
            self.in_channels, self.in_channels, 1, 1, leaky_slope
        )
