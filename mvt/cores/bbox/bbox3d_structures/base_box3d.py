...
from mvt.utils.iou_util import rotate_iou_gpu_eval
from mvt.utils.bbox3d_util import limit_period, xywhr2xyxyr
...
class BaseInstance3DBoxes(object):
    ...
    def overlaps(cls, boxes1, boxes2, mode='iou'):
        ...
        overlaps_bev = rotate_iou_gpu_eval(
            boxes1_bev, boxes2_bev, criterion=2, device_id=boxes1.device)
        overlaps_3d = overlaps_bev.to(boxes1.device) * overlaps_h
