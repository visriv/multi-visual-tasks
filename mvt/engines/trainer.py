...
def train_processor(cfg,
    ...
    if distributed:
        ...
        if cfg.RUNTIME.GPU_IDS != "":
            model = CustomDataParallel(
                model.cuda(cfg.RUNTIME.GPU_IDS[0]), 
                device_ids=cfg.RUNTIME.GPU_IDS)
        else:
    ...
    runner.register_training_hooks(lr_config_dict, optimizer_config,
    ...
    if test_dataset is not None:
        ...
        runner.register_hook(
            eval_hook(test_dataloader, cfg.MODEL.TYPE, **eval_cfg))
