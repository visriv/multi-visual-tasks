...
from mvt.cores.bbox.bbox3d_structures import (
    Box3DMode, CameraInstance3DBoxes, Coord3DMode, LiDARInstance3DBoxes
)
...
class KittiDataset(D3dBaseDataset):
    ...
    def bbox2result_kitti2d(self,
        ...
        det_annos = []
        print('\nConverting prediction to KITTI format')
        for i, bboxes_per_sample in enumerate(net_outputs):
            annos = []
            anno = dict(
                name=[],
                truncated=[],
        ...
        if pklfile_prefix is not None:
            ...
            pickle.dump(det_annos, pklfile_path)
