...
from mvt.engines.predictor import get_detector, inference_detector, show_detector_result
...
if __name__ == "__main__":
    ...
    checkpoint_path = "meta/train_infos/det_yolov4x_cspdarknet_retail_one/epoch_12.pth"

    with_show = True
    show_score_thr = 0.2

    print("Infer the detection results from image with index {}.".format(index))
    assert index >= 0
